...
DEFAULT_ORDER = ["ollama", "gemini", "nvidia", "groq", "cerebras", "openrouter", "github", "anthropic"]
...
TIER_TO_ORDER = {
    "TINY":  ["github", "openrouter", "groq", "anthropic", "nvidia", "cerebras", "gemini", "ollama"],
    "LARGE": ["gemini", "anthropic", "groq", "nvidia", "cerebras", "github", "openrouter", "ollama"],
}
